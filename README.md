...
<!-- CI badge goes live once pushed to GitHub; replace OWNER/REPO with the real path -->
![detections-ci](https://github.com/OWNER/REPO/actions/workflows/detections-ci.yml/badge.svg)
...
Rules are version-controlled and validated in CI ([`.github/workflows/detections-ci.yml`](./.github/workflows/detections-ci.yml)): XML syntax, **sample-event tests that assert each rule fires** ([`tests/`](./tests)), Sigma lint on the [portable Sigma equivalents](./detections/sigma), and a gitleaks secret scan. Break a rule in a PR and CI goes red.
...
| [`.github/workflows/`](./.github/workflows) | `detections-ci.yml` — syntax, rule-firing, Sigma lint, secret scan |
